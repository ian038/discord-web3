...
const gun = Gun(['https://discord-web3-server.herokuapp.com/gun'])
...
export const DiscordProvider = ({ children }) => {
  ...
  const value = { currentAccount, roomName, setRoomName, placeholder, messageText, setMessageText, state, gun, connectWallet, currentUser }
